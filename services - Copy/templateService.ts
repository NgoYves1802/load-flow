...
export const IEEE_5_BUS: NetworkState = {
  nodes: [
    { id: '5b-1', name: 'Bus 1', type: NodeType.SLACK, category: 'Generation', voltage: 1.06, angle: 0, pGen: 0, qGen: 0, pLoad: 0, qLoad: 0, x: 400, y: 100, iconType: 'alternator-slack' },
    { id: '5b-2', name: 'Bus 2', type: NodeType.PV, category: 'Generation', voltage: 1.0, angle: 0, pGen: 40, qGen: 0, pLoad: 20, qLoad: 10, x: 150, y: 250, iconType: 'alternator-pv' },
  ...
  edges: [
    { id: '5e-1', from: '5b-1', to: '5b-2', resistance: 0.02, reactance: 0.06, susceptance: 0.03, limit: 100 },
    { id: '5e-2', from: '5b-1', to: '5b-3', resistance: 0.08, reactance: 0.24, susceptance: 0.025, limit: 100 },
    { id: '5e-3', from: '5b-2', to: '5b-3', resistance: 0.06, reactance: 0.18, susceptance: 0.02, limit: 100 },
    { id: '5e-4', from: '5b-2', to: '5b-4', resistance: 0.06, reactance: 0.18, susceptance: 0.02, limit: 100 },
    { id: '5e-5', from: '5b-2', to: '5b-5', resistance: 0.04, reactance: 0.12, susceptance: 0.015, limit: 100 },
    { id: '5e-6', from: '5b-3', to: '5b-4', resistance: 0.01, reactance: 0.03, susceptance: 0.01, limit: 100 },
    { id: '5e-7', from: '5b-4', to: '5b-5', resistance: 0.08, reactance: 0.24, susceptance: 0.025, limit: 100 }
  ]
};
